...
+ Access numerous [**{dplyr}**](https://dplyr.tidyverse.org)-like functions
following the `{dplyr_verb}_data` naming convention:
   - Supported dplyr-like functions: `arrange_data()` `filter_data()`, `select_data()`,
